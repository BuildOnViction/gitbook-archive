...
To test out the examples in this guide on Tomochain [mainnet](../working-with-tomochain/tomochain-mainnet.md) or [testnet](../working-with-tomochain/tomochain-testnet.md), you will need to have the corresponding RPC API endpoints and some native TOMO tokens.

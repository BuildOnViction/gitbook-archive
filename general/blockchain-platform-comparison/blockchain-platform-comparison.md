...
## Overview of TomoChain <a href="#b088" id="b088"></a>
...
> TomoChain aims to be a public EVM-compatible blockchain with the following advantages: low transaction fees, fast confirmation time, double validation and randomization for security guarantees. TomoChain Labs envisions an ecosystem of different Dapps running on the TomoChain blockchain infrastructure.
...
[In the technical paper](https://tomochain.com/files/technical-whitepaper-1.0.pdf), TomoChain proposed the Proof-of-Stake Voting (PoSV) consensus, which is a PoS-based blockchain protocol with a fair voting mechanism, rigorous security guarantees, and uniform probability eventually. The consensus has the following key novelties:
